...
class GameBoardPanel extends JPanel {
	 ...
	 * is used for all the games played until we exit the app.
	 * 
	...
	private class SquareListener extends MouseAdapter {
		...
		/**
		 * Open this square. This in turn may recursively open other squares. If this
		 * square has a mine in it this action can end the game (in a loss). If this is
		 * the first one to be opened in a game, this will trigger the initial placement
		 * of the mines before the recursion (and guarantee that so no mine is on this
